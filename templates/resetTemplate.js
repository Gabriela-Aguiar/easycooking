const resetTemplate = ( id ) => {
    return (
        ...
        @media only screen and (max-width:480px) {
          ...
          <img
             alt="" height="auto" src="url(/images/cook.jpg)" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
          />
