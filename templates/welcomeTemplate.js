const template = ( username ) => {
    ...
    @media only screen and (max-width:480px) {
      ...
      <img
         alt="" height="auto" src="https://images.squarespace-cdn.com/content/v1/50be6057e4b030a9a18e24ba/1557162757578-0O8LQ4Z61S5MD0HFBPYR/ke17ZwdGBToddI8pDm48kKvaXCAuL7ddSLTqhI9LUKR7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0lCvyAd1-5UQFnp8aARaJsWU1k2HvwRNavqDDuYN0FaaLHjhNz7mZ86a8cfR4T97bA/lifestyle+image+of+woman+cooking+in+a+modern+kitchen" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <div  style="background:#F1935C;background-color:#F1935C;margin:0px auto;max-width:600px;">
        
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#F1935C;background-color:#F1935C;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      >We&apos;re really excited you&apos;ve decided to give us a try. <br>
      Are you ready to start cooking delicious meals for you or the ones you love? <br></br>So let&apos;s get started!</div>
      ...
      <div
         style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:left;color:#ffffff;"
      >Thanks, <br /> Easy Cooking Team</div>
